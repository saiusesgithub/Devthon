  ...
  const prizes = [
    {
      rank: "Gold",
      amount: "$5000",
      perks: ["Trophy", "Certificates", "Internship Opportunities", "Goody Bag"],
      icon: "🥇",
    ...
    },
    {
      rank: "Silver",
      amount: "$3000",
      perks: ["Trophy", "Certificates", "Goody Bag", "Tech Merchandise"],
      icon: "🥈",
    ...
    },
    {
      rank: "Bronze",
      amount: "$2000",
      perks: ["Trophy", "Certificates", "Goody Bag", "Discount Coupons"],
      icon: "🥉",
